Function Repair-JavaBuildUtils
{
	...
	Process {
		$ModDirs | ForEach-Object -Process {
			...
			ForEach {
				if(Test-Path "../JavaBuildUtils") {
					Write-Verbose "Old Module folder detected, removing..."
					Remove-Item "../JavaBuildUtils" -Recurse -Force
				}
				Write-Verbose "Installing Latest JavaBuildUtils Module folder..."
				Move-Item "JavaBuildUtils" ".." 
			}
		}
	}
